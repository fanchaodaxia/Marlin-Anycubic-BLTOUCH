...
#define STRING_CONFIG_H_AUTHOR "(Chao)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Chao's delta"
...
#define DELTA
  ...
  #define DELTA_RADIUS 115.0 //mm  Get this value from auto calibrate
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 31.5     // Z probe to nozzle X offset: -left  +right
#define Y_PROBE_OFFSET_FROM_EXTRUDER 17.5     // Z probe to nozzle Y offset: -front +behind
...
#define Z_CLEARANCE_BETWEEN_PROBES 13 // Z Clearance between probe points
